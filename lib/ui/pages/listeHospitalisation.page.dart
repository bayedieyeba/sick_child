...
class _ListeHospitalisation extends State<ListeHospitalisation> {
  ...
  TextEditingController codeEnfantTextEditingController =
  ...
  void initState() {
    super.initState();
    String url = "http://10.0.2.2:8083/api/enfant/enHospitalisation";
  ...
  void _search(String? codeEnfant) {
    String url = "http://10.0.2.2:8083/api/enfant/trouver-enfant";
    http
        .post(
      Uri.parse(url),
                              ...
                              MaterialPageRoute(
                                  builder: (context) => DetailEnfant(
                                      ...
                                      telephoneParent: data[index]
                                          ['telephoneParent'],
                                      monatnt: data[index]['montant'],
                                      typeCancer: data[index]['typeCancer'])));
                        },
                        title: Row(
